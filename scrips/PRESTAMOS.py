...
class PrestamoWindowClass(QMainWindow):
    def __init__(self):
        ...
        uic.loadUi("D:/PROYECTO_FINAL_BIBLIOTECA/Ventanas/Agregar_Prestamo.ui", self)
        self.setWindowTitle("Agregar Prestamo")
